...
pub const PIMAGE_TLS_CALLBACK = ?*const fn (windows.PVOID, windows.DWORD, ?windows.PVOID) callconv(windows.WINAPI) void;

pub const IMAGE_TLS_DIRECTORY32 = extern struct {
    StartAddressOfRawData: windows.DWORD,
    EndAddressOfRawData: windows.DWORD,
    AddressOfIndex: *windows.DWORD,
    AddressOfCallBacks: [*c]PIMAGE_TLS_CALLBACK,
    SizeOfZeroFill: windows.DWORD,
    Characteristics: windows.DWORD,
};

pub const IMAGE_TLS_DIRECTORY64 = extern struct {
    StartAddressOfRawData: windows.ULONGLONG,
    EndAddressOfRawData: windows.ULONGLONG,
    AddressOfIndex: *windows.ULONGLONG,
    AddressOfCallBacks: [*c]PIMAGE_TLS_CALLBACK,
    SizeOfZeroFill: windows.DWORD,
    Characteristics: windows.DWORD,
};

pub const IMAGE_TLS_DIRECTORY = if (@sizeOf(usize) == 4) IMAGE_TLS_DIRECTORY32 else IMAGE_TLS_DIRECTORY64;
...
pub const FnStdCallLdrpHandleTlsData = *const fn (*LDR_DATA_TABLE_ENTRY) callconv(windows.WINAPI) void;
pub const FnThisCallLdrpHandleTlsData = *const fn (*LDR_DATA_TABLE_ENTRY) callconv(.Thiscall) void;
...
pub const WIN32_WIN_NT_NT4: u16 = 0x0400;
pub const WIN32_WIN_NT_WIN2_K: u16 = 0x0500;
pub const WIN32_WIN_NT_WINXP: u16 = 0x0501;
pub const WIN32_WIN_NT_WS03: u16 = 0x0502;
pub const WIN32_WIN_NT_WIN6: u16 = 0x0600;
pub const WIN32_WIN_NT_VISTA: u16 = 0x0600;
pub const WIN32_WIN_NT_WS08: u16 = 0x0600;
pub const WIN32_WIN_NT_LONGHORN: u16 = 0x0600;
pub const WIN32_WIN_NT_WIN7: u16 = 0x0601;
